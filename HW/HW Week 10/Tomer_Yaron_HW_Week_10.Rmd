...
In order to access the normalized matrix, we need to use the function _normalize_:

```{r norm_matrix}

sc_exp_filter_norm <- normalize(sc_exp_filter)
head(counts(sc_exp_filter_norm[,1:10]), 10)
