...
2. **Reads Count**: We can see that the biological replicates are vary from each other by the total number of reads. Overall, there are more reads in the SNF2 samples compare to the WT samples. In addition, whereas WT-4 and SNF2-4 both have high number of reads, the other WT-SNF2 couples are not always correlated in their number of total reads.
